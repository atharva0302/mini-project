...
typedef enum {Sunday,monday,tuesday,wenesday,thusday,friday,saturday}
     WEEK;

typedef enum {January ,February,Match,Apirl,May,June,July,August,September,October,November,December}
MONTH;
void printMonHead(void)
{
   printf("    Sunday,Monday,thusday,wenesday,thusday,friday,saturday");
}
